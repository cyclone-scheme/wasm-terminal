...
all:
	...
	emcc src/terminal.c  -g4 -fPIC -Wall -Wno-shift-negative-value -Wno-unused-command-line-argument -I$(CYC_DIR)/include -c -o terminal.o
	emcc terminal.o \
	  ...
	  $(CYC_DIR)/libs/cyclone/foreign.o \
